...
## Core Features
- **Word-Accurate Manuscript Formatting**: Default A5 paper (148 × 210 mm), TH Sarabun New 16pt, Left-aligned, 0.5 cm first-line indent, Multiple 1.08 line spacing (`line: 259`).
